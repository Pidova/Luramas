...
namespace vm {
      ...
      void VADDSUBPD(const registrar &registrar, const std::vector<luramas::il::lifter::builder::build::expr> &operands) {
            ...
            switch (dest.bits()) {
                  case 128U: {
                        dest.write(0U, 63U, sr_c1.read(0U, 63U) - sr_c2.read(0U, 63U));
                        dest.write(64U, 127U, sr_c1.read(64U, 127U) + sr_c2.read(64U, 127U));
                  ...
                  case 256U: {
                        dest.write(0U, 63U, sr_c1.read(0U, 63U) - sr_c2.read(0U, 63U));
                        dest.write(64U, 127U, sr_c1.read(64U, 127U) + sr_c2.read(64U, 127U));
                        dest.write(128U, 191U, sr_c1.read(128U, 191U) - sr_c2.read(128U, 191U));
                        dest.write(192U, 255U, sr_c1.read(192U, 255U) + sr_c2.read(192U, 255U));
                        break;
                  }
                  default: {
                        break;
      ...
      void VADDSUBPS(const registrar &registrar, const std::vector<luramas::il::lifter::builder::build::expr> &operands) {
            ...
            switch (dest.bits()) {
                  case 128U: {
                        dest.write(0U, 31U, sr_c1.read(0U, 31U) - sr_c2.read(0U, 31U));
                        dest.write(32U, 63U, sr_c1.read(32U, 63U) + sr_c2.read(32U, 63U));
                        dest.write(64U, 95U, sr_c1.read(64U, 95U) - sr_c2.read(64U, 95U));
                        dest.write(96U, 127U, sr_c1.read(96U, 127U) + sr_c2.read(96U, 127U));
                        dest.write(128U, registrar.hw_constants.MAXVL - 1U, 0U);
                        break;
                  }
                  case 256U: {
                        ...
                        dest.write(64U, 95U, sr_c1.read(64U, 95U) - sr_c2.read(64U, 95U));
                        dest.write(96U, 127U, sr_c1.read(96U, 127U) + sr_c2.read(96U, 127U));
                        dest.write(128U, 159U, sr_c1.read(128U, 159U) - sr_c2.read(128U, 159U));
                        dest.write(160U, 191U, sr_c1.read(160U, 191U) + sr_c2.read(160U, 191U));
                        dest.write(192U, 223U, sr_c1.read(192U, 223U) - sr_c2.read(192U, 223U));
                        dest.write(224U, 255U, sr_c1.read(224U, 255U) + sr_c2.read(224U, 255U));
                        break;
                  }
                  default: {
                        break;
