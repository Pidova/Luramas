...
namespace luramas::ir::generation::ssa {

      ssa generate(se_ir &ir, const ssa_flags &f, const std::optional<boost::unordered_flat_map<std::shared_ptr<ir_stat>, luramas::ir::definitions::exprs>> &exprs, const std::optional<cfg::cfg> &ocfg) {
