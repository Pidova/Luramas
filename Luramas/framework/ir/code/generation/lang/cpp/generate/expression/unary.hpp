...
namespace luramas::ir::code::emitter::cpp::unary {
      ...
      inline void emit_unary(std::string &buffer, const luramas::il::arch::data::bin_kinds unary, const std::shared_ptr<luramas::ir::data::format::format> &format) {
            ...
            switch (unary) {
                  ...
                  case luramas::il::arch::data::bin_kinds::not_: {
                        buffer = format->spacing.format_unary_not(cpp_langkeyword_not) + buffer;
                        break;
                  }
                  case luramas::il::arch::data::bin_kinds::minus_: {
                        buffer = format->spacing.format_unary_minus(cpp_langkeyword_minus) + buffer;
                        break;
                  }
                  case luramas::il::arch::data::bin_kinds::bitnot_: {
                        buffer = format->spacing.format_unary_bitnot(cpp_langkeyword_bitnot) + buffer;
                        break;
                  }
                  default: {
