...
namespace luramas::ir::code::emitter::cpp::branch {
      ...
      inline void emit_if(std::string &buffer, const luramas::il::arch::data::bin_kinds op, std::string &lvalue, std::string &rvalue, const std::shared_ptr<luramas::ir::data::format::format> &format) {
            ...
            buffer += format->spacing.format_compare(cpp_langkeyword_scope_if);
            ...
            buffer += format->spacing.format_scope_begin(cpp_langkeyword_scope_if_begin);
            return;
      }
      ...
      inline void emit_elseif(std::string &buffer, const luramas::il::arch::data::bin_kinds op, const std::string &lvalue, const std::string &rvalue, const std::shared_ptr<luramas::ir::data::format::format> &format) {
            ...
            buffer += format->spacing.format_compare(cpp_langkeyword_scope_elseif);

            std::string ref("");
            luramas::ir::code::emitter::cpp::logical::emit_logical_operation(ref, op, lvalue, rvalue, format);

            buffer += format->spacing.format_parenthesis_ref(cpp_langkeyword_parenthesis_open, ref, cpp_langkeyword_parenthesis_close);
            buffer += format->spacing.format_scope_begin(cpp_langkeyword_scope_elseif_begin);
            return;
      }
      ...
      inline void emit_else(std::string &buffer, const std::shared_ptr<luramas::ir::data::format::format> &format) {
            buffer += format->spacing.format_compare(cpp_langkeyword_scope_else);
            buffer += format->spacing.format_scope_begin(cpp_langkeyword_scope_else_begin);
            return;
      }
      ...
      inline void emit_goto_label(std::string &buffer, const std::string &name, const std::shared_ptr<luramas::ir::data::format::format> &format) {
            ...
            buffer += format->spacing.format_goto(cpp_langkeyword_scope_goto);
            buffer += name;
            return;
      }
      ...
      inline void emit_label(std::string &buffer, const std::string &name, const std::shared_ptr<luramas::ir::data::format::format> &format) {
            ...
            buffer += cpp_langkeyword_scope_label_begin;
            buffer += name;
            buffer += cpp_langkeyword_scope_label_end;
            return;
      }
