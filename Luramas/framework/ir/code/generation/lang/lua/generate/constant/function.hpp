...
namespace luramas::ir::code::emitter::lua::function {
      ...
      inline void emit_global_function(std::string &buffer, const std::string &name, const std::vector<std::string> &params, const std::string &data, const std::shared_ptr<luramas::ir::data::format::format> &format) {
            ...
            buffer += format->spacing.format_function(lua_langkeyword_function);
            buffer += name;
            ...
            for (auto i = 0u; i < count; ++i) {
                  ...
                  if ((i + 1u) != count) {
                        func_params += format->spacing.format_parameter_delimiter(lua_langkeyword_function_delimeter);
                  }
            }

            /* ( ?? ) */
            func_params = format->spacing.format_parameter_open(lua_langkeyword_function_params_parenthesis_open) + func_params;
            func_params += format->spacing.format_parameter_close(lua_langkeyword_function_params_parenthesis_close);
            buffer += func_params;
            ...
            /*
                ...
                ??
            */
            luramas::ir::code::emitter::lua::line::emit_linebreak(buffer, 1u, format);
            buffer += data;
            return;
      }
      ...
      inline void emit_anonymous_function(std::string &buffer, const std::vector<std::string> &params, const std::string &data, const std::shared_ptr<luramas::ir::data::format::format> &format) {
            ...
            buffer += format->spacing.format_function(lua_langkeyword_function_anonymous);
      ...
      inline void emit_anonymous_function_end(std::string &buffer, const std::shared_ptr<luramas::ir::data::format::format> &format) {
            ...
            buffer += lua_langkeyword_function_anonymous_end;
            return;
      }
} // namespace luramas::ir::code::emitter::lua::function