...
namespace luramas::ir {
      ...
      /* IR logical expression kinds (Stats can not support logicals natively without a cond ET to keep things non-ambiguous) */
      ...
      enum class tkind : std::uint8_t {
            ...
            global,     /* Global variable, env flags determine what the syntax of a global looks like in the exprs V  */
            boolean,    /* Boolean type */
            kvalue,     /* Constant values */
