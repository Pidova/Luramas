                  ...
                  for (auto i = 0U; i < op_count; ++i) {
                        ...
                        switch (current_operand->type) {
                              ...
                              case op_table::type::k_idx: {
                                    ...
                                    current_operand->k_value_type = kv.tt_ & 0x0F;
                                    switch (current_operand->k_value_type) {
                                          ...
                                          case LUA_TNUMBER: {
                                                current_operand->k_value = std::to_string(ttisinteger(&kv) ? static_cast<double>(kv.value_.i) : kv.value_.n);
                                                break;
                                          }
                                          case LUA_TSTRING: {
                                                ...
                                                current_operand->k_value = data;
                                                luramas_str_escape(current_operand->k_value);
                                                current_operand->k_value = '\"' + current_operand->k_value + '\"';
                                                break;
                                          }
                                          ...
                                          case LUA_TTHREAD: {
                                                current_operand->k_value = "thread_" + std::to_string(operand_value);
                                                break;
                                          }
                                          default: {
