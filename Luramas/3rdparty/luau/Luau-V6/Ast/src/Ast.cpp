...
namespace Luau {
      ...
      AstExprCall::AstExprCall(const Location &location, AstExpr *func, const AstArray<AstExpr *> &args, bool self, const Location &argLocation)
          : AstExpr(ClassIndex(), location), func(func), args(args), self(self), argLocation(argLocation) {
      }
      ...
      AstExprIndexName::AstExprIndexName(
          ...
          char op)
          : AstExpr(ClassIndex(), location), expr(expr), index(index), indexLocation(indexLocation), opPosition(opPosition), op(op) {
      }
      ...
      AstExprFunction::AstExprFunction(
          ...
          : AstExpr(ClassIndex(), location), attributes(attributes), generics(generics), genericPacks(genericPacks), self(self), args(args), returnAnnotation(returnAnnotation), vararg(vararg), varargLocation(varargLocation), varargAnnotation(varargAnnotation), body(body), functionDepth(functionDepth), debugname(debugname), argLocation(argLocation) {
      }
      ...
      AstExprIfElse::AstExprIfElse(const Location &location, AstExpr *condition, bool hasThen, AstExpr *trueExpr, bool hasElse, AstExpr *falseExpr)
          : AstExpr(ClassIndex(), location), condition(condition), hasThen(hasThen), trueExpr(trueExpr), hasElse(hasElse), falseExpr(falseExpr) {
      }
      ...
      AstExprError::AstExprError(const Location &location, const AstArray<AstExpr *> &expressions, unsigned messageIndex)
          : AstExpr(ClassIndex(), location), expressions(expressions), messageIndex(messageIndex) {
      }
      ...
      AstExprInterpString::AstExprInterpString(const Location &location, const AstArray<AstArray<char>> &strings, const AstArray<AstExpr *> &expressions)
          : AstExpr(ClassIndex(), location), strings(strings), expressions(expressions) {
      }
      ...
      AstStatWhile::AstStatWhile(const Location &location, AstExpr *condition, AstStatBlock *body, bool hasDo, const Location &doLocation)
          : AstStat(ClassIndex(), location), condition(condition), body(body), hasDo(hasDo), doLocation(doLocation) {
      }
      ...
      AstStatRepeat::AstStatRepeat(const Location &location, AstExpr *condition, AstStatBlock *body, bool DEPRECATED_hasUntil)
          : AstStat(ClassIndex(), location), condition(condition), body(body), DEPRECATED_hasUntil(DEPRECATED_hasUntil) {
      }
      ...
      AstStatLocal::AstStatLocal(
          ...
          : AstStat(ClassIndex(), location), vars(vars), values(values), equalsSignLocation(equalsSignLocation) {
      }
      ...
      AstStatFor::AstStatFor(
          ...
          : AstStat(ClassIndex(), location), var(var), from(from), to(to), step(step), body(body), hasDo(hasDo), doLocation(doLocation) {
      }
      ...
      AstStatForIn::AstStatForIn(
          ...
          bool hasDo,
          const Location &doLocation)
          : AstStat(ClassIndex(), location), vars(vars), values(values), body(body), hasIn(hasIn), inLocation(inLocation), hasDo(hasDo), doLocation(doLocation) {
      }
      ...
      AstStatTypeAlias::AstStatTypeAlias(
          ...
          AstType *type,
          bool exported)
          : AstStat(ClassIndex(), location), name(name), nameLocation(nameLocation), generics(generics), genericPacks(genericPacks), type(type), exported(exported) {
      }
      ...
      AstStatTypeFunction::AstStatTypeFunction(const Location &location, const AstName &name, const Location &nameLocation, AstExprFunction *body)
          : AstStat(ClassIndex(), location), name(name), nameLocation(nameLocation), body(body) {
      }
      ...
      AstStatDeclareGlobal::AstStatDeclareGlobal(const Location &location, const AstName &name, const Location &nameLocation, AstType *type)
          : AstStat(ClassIndex(), location), name(name), nameLocation(nameLocation), type(type) {
      }
      ...
      AstStatDeclareFunction::AstStatDeclareFunction(
          ...
          : AstStat(ClassIndex(), location), attributes(), name(name), nameLocation(nameLocation), generics(generics), genericPacks(genericPacks), params(params), paramNames(paramNames), vararg(vararg), varargLocation(varargLocation), retTypes(retTypes) {
      }
      ...
      AstStatDeclareFunction::AstStatDeclareFunction(
          ...
          const Location &varargLocation,
          const AstTypeList &retTypes)
          : AstStat(ClassIndex(), location), attributes(attributes), name(name), nameLocation(nameLocation), generics(generics), genericPacks(genericPacks), params(params), paramNames(paramNames), vararg(vararg), varargLocation(varargLocation), retTypes(retTypes) {
      }
      ...
      AstStatDeclareClass::AstStatDeclareClass(
          ...
          : AstStat(ClassIndex(), location), name(name), superName(superName), props(props), indexer(indexer) {
      }
      ...
      AstStatError::AstStatError(
          ...
          : AstStat(ClassIndex(), location), expressions(expressions), statements(statements), messageIndex(messageIndex) {
      }
      ...
      AstTypeReference::AstTypeReference(
          ...
          : AstType(ClassIndex(), location), hasParameterList(hasParameterList), prefix(prefix), prefixLocation(prefixLocation), name(name), nameLocation(nameLocation), parameters(parameters) {
      }
      ...
      AstTypeFunction::AstTypeFunction(
          ...
          : AstType(ClassIndex(), location), attributes(), generics(generics), genericPacks(genericPacks), argTypes(argTypes), argNames(argNames), returnTypes(returnTypes) {
      ...
      AstTypeFunction::AstTypeFunction(
          ...
          const AstArray<std::optional<AstArgumentName>> &argNames,
          const AstTypeList &returnTypes)
          : AstType(ClassIndex(), location), attributes(attributes), generics(generics), genericPacks(genericPacks), argTypes(argTypes), argNames(argNames), returnTypes(returnTypes) {
            LUAU_ASSERT(argNames.size == 0 || argNames.size == argTypes.types.size);
      }
      ...
      AstTypeError::AstTypeError(const Location &location, const AstArray<AstType *> &types, bool isMissing, unsigned messageIndex)
          : AstType(ClassIndex(), location), types(types), isMissing(isMissing), messageIndex(messageIndex) {
      }
