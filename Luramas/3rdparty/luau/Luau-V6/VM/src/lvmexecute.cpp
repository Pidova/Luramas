...
#define VM_INTERRUPT()                                                                                      \
      {                                                                                                     \
            ...
            if (LUAU_UNLIKELY(!!interrupt)) { /* the interrupt hook is called right before we advance pc */ \
...
#endif
            {
                  ...
                  VM_CASE(LOP_POWK) {
                        ...
                        if (ttisnumber(rb)) {
                              ...
                              double r = (nk == 2.0) ? nb * nb : (nk == 0.5) ? sqrt(nb)
                                                             : (nk == 3.0)   ? nb * nb * nb
                                                                             : pow(nb, nk);
                  ...
                  VM_CASE(LOP_FORGPREP) {
                        ...
                        if (ttisfunction(ra)) {
                              ...
                              Table *mt = ttistable(ra) ? hvalue(ra)->metatable : ttisuserdata(ra) ? uvalue(ra)->metatable
                                                                                                   : cast_to(Table *, NULL);
