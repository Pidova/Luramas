...
def main() -> int:
    parser = argparse.ArgumentParser(description="Wrap C/C++ files in a preprocessor guard.");
    parser.add_argument("folder", type=Path, help="Input folder to process recursively.");
    parser.add_argument(
        "-m", "--macro", required=True,
