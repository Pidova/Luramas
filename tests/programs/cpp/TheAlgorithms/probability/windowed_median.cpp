 ...
 */
     ...
     */
                  explicit WindowedMedian(size_type windowSize)
...
int main() {
      ...
      /// values
      test({470211272, 101027544, 1457850878, 1458777923, 2007237709, 823564440, 1115438165, 1784484492, 74243042, 114807987},
          6);
