     ...
     */
                ...
                public:
                  using MapOfPuzzleInfoWithPuzzleInfo =
                      std::map<std::shared_ptr<Info>, std::shared_ptr<Info>, comparison_operator>;
                        ...
                        while (!open_list.empty()) {
                              ...
                              for (Puzzle &neighbor : total_possible_moves) {
                                    ...
                                    std::shared_ptr<Info> Neighbor = std::make_shared<Info>(
                                        neighbor, dist(neighbor, *(Final->state)), current_state->depth + 1U);
