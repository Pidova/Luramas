...
static void test() {
      ...
      std::cout << hashing::sha1::sig2hex(sig) << std::endl
                << std::endl;
      ...
      std::cout << "Hashing The quick brown fox jumps over the lazy dog"
                << std::endl;
      // Prints signature hex representation
      std::cout << hashing::sha1::sig2hex(sig2) << std::endl
                << std::endl;
      // Test with cassert wether sig is correct from expected value
      ...
      std::cout << "Hashing "
                ...
                << std::endl;
      // Prints signature hex representation
      std::cout << hashing::sha1::sig2hex(sig3) << std::endl
                << std::endl;
      // Test with cassert wether sig is correct from expected value
      ...
      std::cout
          ...
          << std::endl;
      // Prints signature hex representation
      std::cout << hashing::sha1::sig2hex(sig4) << std::endl
                << std::endl;
      // Test with cassert wether sig is correct from expected value
